  ...
  const claims = [
    {
      ...
      status: "approved",
      description:
        "Urgent surgery required for my father. Hospital bills need immediate payment for life-saving operation.",
    ...
    },
    {
      ...
      status: "pending",
      description:
        "House damaged due to recent floods. Need funds for temporary accommodation and basic necessities.",
    ...
    },
    {
      ...
      status: "pending",
      description:
        "Family emergency requiring immediate financial support for critical medical treatment.",
    ...
    },
    {
      ...
      status: "rejected",
      description:
        "Lost my job due to company downsizing. Need support for monthly expenses and children's education.",
      document: "termination_letter.pdf",
      verification: "✓ Verified by 3rd party",
      rejection:
        "Insufficient supporting documentation. Please provide additional proof of job loss and current financial situation.",
    },
  ];
  ...
  return (
    <div className="container">
      ...
      <p className="description">
        Submit emergency claims to access community support funds during
        critical situations. All claims are reviewed by the community and
        verified through third-party documentation to ensure authenticity and
      ...
      <div className="timer-section">
        ...
        <div className="timer-text">
          You can raise an emergency claim within:
        </div>
        ...
        <div className="timer-warning">
          After this period, emergency claims for this cycle will be closed.
        </div>
      </div>
      ...
      <div className="claims-section">
        <div className="claims-header">
          ...
          <div className="verification-badge">
            ✓ Third-party document verification enabled
          </div>
        </div>
        ...
        <div id="claimsContainer">
          {filteredClaims.map((claim) => (
            <div
              key={claim.id}
              className={`claim-item ${claim.status}-claim`}
            >
              <div className="claim-header">
                <div>
                  <div className="claim-title">{claim.title}</div>
                  <div className="claim-meta">
                    Submitted by {claim.user} • {claim.date}
                  </div>
                </div>
              ...
              {claim.rejection && (
                <div className="rejection-reason">
                  <strong>Rejection Reason:</strong> {claim.rejection}
                </div>
              )}
            </div>
          ))}
            ...
            >
              ...
              <div className="form-group">
                ...
                <textarea
                  ...
                  placeholder="Please provide detailed information about your emergency situation..."
                  required
                ></textarea>
              </div>
  ...
  <div className="upload-hint">
    Upload proof of emergency (medical bills, official documents, etc.)
              ...
              <div className="form-group">
                ...
                <div className="upload-hint">
                  Upload proof of emergency (medical bills, official documents,
                  etc.)
                </div>
              </div>
